...
using SargeStoreDomain.DTO.Identity;
...
namespace SargeStore.ServiceHosting.Controllers
{
    ...
    {
        private readonly UserStore<User, Role, SargeStoreDB> _UserStore;

        public UsersApiController(SargeStoreDB db) => _UserStore = new UserStore<User, Role, SargeStoreDB>(db);
        ...
        [HttpPost("Role/{role}")]
        public async Task AddToRoleAsync([FromBody] User user, string role, [FromServices] SargeStoreDB db)
        {
        ...
        public async Task RemoveFromRoleAsync([FromBody] User user, string role, [FromServices] SargeStoreDB db)
        {
        ...
        [HttpPost("AddClaims")]
        public async Task AddClaimsAsync([FromBody] AddClaimDTO ClaimInfo, [FromServices] SargeStoreDB db)
        {
        ...
        public async Task ReplaceClaimAsync([FromBody] ReplaceClaimDTO ClaimInfo, [FromServices] SargeStoreDB db)
        {
        ...
        public async Task RemoveClaimsAsync([FromBody] RemoveClaimDTO ClaimInfo, [FromServices] SargeStoreDB db)
        {
        ...
        [HttpPost("AddLogin")]
        public async Task AddLoginAsync([FromBody] AddLoginDTO login, [FromServices] SargeStoreDB db)
        {
        ...
        public async Task RemoveLoginAsync([FromBody] User user, string LoginProvider, string ProviderKey, [FromServices] SargeStoreDB db)
        {
